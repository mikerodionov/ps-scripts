...
Get-EventLog -LogName system -Source "service control manager" |?{$_.message -match "blackpearl"} | ?{$_.message -match "unexpectedly"} | select timegenerated, message -First 30
